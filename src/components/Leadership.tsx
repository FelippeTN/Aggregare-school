              ...
              <div className="grid md:grid-cols-2 gap-10">
                <div className="flex flex-col">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <h5 className="text-lg font-bold text-slate-800">Formação de Fábio Simas</h5>
                  </div>
                ...
                <div className="flex flex-col">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <h5 className="text-lg font-bold text-slate-800">Formação e experiência de Simone Simas</h5>
                  </div>
