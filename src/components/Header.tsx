...
const Header = () => {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 mx-2 sm:mx-4 lg:mx-10 mt-2 bg-background/95 backdrop-blur-md border rounded-2xl shadow-lg z-50">
        ...
        <div className="flex items-center justify-between h-16 sm:h-18 lg:h-20">
          <div className="flex items-center">
            <img 
              src={logo} 
              alt="Logo do Colégio" 
              className="h-10 w-12 sm:h-12 sm:w-14 lg:h-14 lg:w-15 object-contain" 
            />
          </div>
          ...
          <div className="hidden lg:flex items-center space-x-2 xl:space-x-4">
            <Button 
              ...
              size="sm"
              className="border-primary text-primary hover:bg-primary hover:text-primary-foreground text-xs xl:text-sm whitespace-nowrap px-3 xl:px-4"
            >
              Agende uma Visita
            </Button>
            <Link to="/cadastro-interesse">
              <Button 
                size="sm"
                className="bg-gradient-to-r from-primary to-primary/90 hover:from-primary/90 hover:to-primary text-xs xl:text-sm whitespace-nowrap px-3 xl:px-4"
              >
                Matricule-se
              </Button>
            </Link>
