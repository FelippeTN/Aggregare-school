    ...
    <footer className="bg-primary text-primary-foreground">
      <div className="container mx-auto px-4 py-16">
        <div className="grid lg:grid-cols-4 md:grid-cols-2 gap-8">
          ...
          {/* Links Rápidos */}
          <div className="space-y-6">
            <h4 className="text-xl font-bold text-secondary">Links Rápidos</h4>
          ...
          {/* Contato */}
          <div className="space-y-6">
            <h4 className="text-xl font-bold text-secondary">Contato</h4>
          ...
          {/* Redes Sociais e CTA */}
          <div className="space-y-6">
            <h4 className="text-xl font-bold text-secondary">Conecte-se</h4>
            <div className="space-y-4">
              <div className="flex space-x-4">
                <a 
                  href="#" 
                  className="w-10 h-10 bg-secondary/20 rounded-full flex items-center justify-center hover:bg-secondary hover:text-secondary-foreground transition-all"
                >
                  <Facebook size={20} />
                </a>
                <a 
          ...
          <div className="text-center">
            ...
            <div className="flex justify-center items-center space-x-4">
              <div className="bg-white/10 px-6 py-3 rounded-lg">
                <span className="font-semibold text-secondary">ACSI Brasil</span>
